 ...
 * Use the {@link Order_List#newInstance} factory method to
...
public class Order_List extends Fragment {
    ...
    public static Order_List newInstance(String param1, String param2) {
        Order_List fragment = new Order_List();
